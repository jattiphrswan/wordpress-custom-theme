        ...
        <div class="knsl-rooms-carousel-wrapper">
            <div class="knsl-rooms-carousel-track" id="knslRoomsCarouselTrack">
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/economy-classic-room/')); ?>" aria-label="<?php esc_attr_e('Economy classic room', 'resort-hotel'); ?>">
                        ...
                        <div class="knsl-carousel-card-body">
                            ...
                            <div class="knsl-carousel-card-footer">
                                ...
                                <a href="<?php echo esc_url(home_url('/accommodation/economy-classic-room/')); ?>" class="knsl-carousel-book-btn">
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/triple-classic-room/')); ?>" aria-label="<?php esc_attr_e('Triple classic room', 'resort-hotel'); ?>">
                        ...
                        <div class="knsl-carousel-card-body">
                            ...
                            <div class="knsl-carousel-card-footer">
                                ...
                                <a href="<?php echo esc_url(home_url('/accommodation/triple-classic-room/')); ?>" class="knsl-carousel-book-btn">
                                    <svg class="knsl-book-icon" viewBox="0 0 18 23" aria-hidden="true">
                                        <path d="M0,0 L0,23 L1.594,21.813 L9,16.25 L16.406,21.813 L18,23 L18,0 L0,0 Z M2,2 L16,2 L16,19 L9.594,14.188 L9,13.75 L8.406,14.188 L2,19 L2,2 Z"/>
                                    </svg>
                                    <span><?php esc_html_e('BOOK', 'resort-hotel'); ?></span>
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/double-room/')); ?>" aria-label="<?php esc_attr_e('Double room', 'resort-hotel'); ?>">
                        ...
                        <div class="knsl-carousel-card-body">
                            ...
                            <div class="knsl-carousel-card-footer">
                                ...
                                <a href="<?php echo esc_url(home_url('/accommodation/double-room/')); ?>" class="knsl-carousel-book-btn">
                                    <svg class="knsl-book-icon" viewBox="0 0 18 23" aria-hidden="true">
                                        <path d="M0,0 L0,23 L1.594,21.813 L9,16.25 L16.406,21.813 L18,23 L18,0 L0,0 Z M2,2 L16,2 L16,19 L9.594,14.188 L9,13.75 L8.406,14.188 L2,19 L2,2 Z"/>
                                    </svg>
                                    <span><?php esc_html_e('BOOK', 'resort-hotel'); ?></span>
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/classic-room/')); ?>" aria-label="<?php esc_attr_e('Classic room', 'resort-hotel'); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/room/room-demo-10-950x633.jpg'); ?>" alt="<?php esc_attr_e('Classic room', 'resort-hotel'); ?>">
                            </a>
                        </div>
                        <div class="knsl-carousel-specs">
                            <div class="knsl-carousel-spec-item">
                        ...
                        <div class="knsl-carousel-card-body">
                            <h3 class="knsl-carousel-card-title">
                                <a href="<?php echo esc_url(home_url('/accommodation/classic-room/')); ?>"><?php esc_html_e('Classic room', 'resort-hotel'); ?></a>
                            </h3>
                            <p class="knsl-carousel-card-text">
                                <?php esc_html_e('Image for cattle earth. May one Which life divide sea. Optio veniam quibusdam fugit aspernatur...', 'resort-hotel'); ?>
                            </p>
                            <div class="knsl-carousel-card-footer">
                                ...
                                <a href="<?php echo esc_url(home_url('/accommodation/classic-room/')); ?>" class="knsl-carousel-book-btn">
                                    <svg class="knsl-book-icon" viewBox="0 0 18 23" aria-hidden="true">
                                        <path d="M0,0 L0,23 L1.594,21.813 L9,16.25 L16.406,21.813 L18,23 L18,0 L0,0 Z M2,2 L16,2 L16,19 L9.594,14.188 L9,13.75 L8.406,14.188 L2,19 L2,2 Z"/>
                                    </svg>
                                    <span><?php esc_html_e('BOOK', 'resort-hotel'); ?></span>
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/business-class-room/')); ?>" aria-label="<?php esc_attr_e('Business class room', 'resort-hotel'); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/room/room-demo-14-950x633.jpg'); ?>" alt="<?php esc_attr_e('Business class room', 'resort-hotel'); ?>">
                            </a>
                        </div>
                        <div class="knsl-carousel-specs">
                            <div class="knsl-carousel-spec-item">
                        ...
                        <div class="knsl-carousel-card-body">
                            ...
                            <div class="knsl-carousel-card-footer">
                                ...
                                <a href="<?php echo esc_url(home_url('/accommodation/business-class-room/')); ?>" class="knsl-carousel-book-btn">
                                    <svg class="knsl-book-icon" viewBox="0 0 18 23" aria-hidden="true">
                                        <path d="M0,0 L0,23 L1.594,21.813 L9,16.25 L16.406,21.813 L18,23 L18,0 L0,0 Z M2,2 L16,2 L16,19 L9.594,14.188 L9,13.75 L8.406,14.188 L2,19 L2,2 Z"/>
                                    </svg>
                                    <span><?php esc_html_e('BOOK', 'resort-hotel'); ?></span>
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/royal-class-room/')); ?>" aria-label="<?php esc_attr_e('Royal class room', 'resort-hotel'); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/room/room-demo-15-950x633.jpg'); ?>" alt="<?php esc_attr_e('Royal class room', 'resort-hotel'); ?>">
                            </a>
                        </div>
                        <div class="knsl-carousel-specs">
                            <div class="knsl-carousel-spec-item">
                            ...
                            <div class="knsl-carousel-spec-item">
                                ...
                                <span><?php esc_html_e('Size: 68ft²', 'resort-hotel'); ?></span>
                            </div>
                        </div>
                        <div class="knsl-carousel-card-body">
                            <h3 class="knsl-carousel-card-title">
                            ...
                            <div class="knsl-carousel-card-footer">
                                ...
                                <a href="<?php echo esc_url(home_url('/accommodation/royal-class-room/')); ?>" class="knsl-carousel-book-btn">
                                    <svg class="knsl-book-icon" viewBox="0 0 18 23" aria-hidden="true">
                                        <path d="M0,0 L0,23 L1.594,21.813 L9,16.25 L16.406,21.813 L18,23 L18,0 L0,0 Z M2,2 L16,2 L16,19 L9.594,14.188 L9,13.75 L8.406,14.188 L2,19 L2,2 Z"/>
                                    </svg>
                                    <span><?php esc_html_e('BOOK', 'resort-hotel'); ?></span>
                ...
                <article class="knsl-carousel-card">
                    <div class="knsl-carousel-card-inner">
                        <div class="knsl-carousel-card-cover">
                            <a href="<?php echo esc_url(home_url('/accommodation/superior-ocean-room/')); ?>" aria-label="<?php esc_attr_e('Superior ocean room', 'resort-hotel'); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/room/room-demo-13-950x633.jpg'); ?>" alt="<?php esc_attr_e('Superior ocean room', 'resort-hotel'); ?>">
                            </a>
                        </div>
                        <div class="knsl-carousel-specs">
                            <div class="knsl-carousel-spec-item">
                            ...
                            <div class="knsl-carousel-spec-item">
                                ...
                                <span><?php esc_html_e('Size: 45ft²', 'resort-hotel'); ?></span>
                            </div>
                        </div>
                        <div class="knsl-carousel-card-body">
                            <h3 class="knsl-carousel-card-title">
                            ...
                            <div class="knsl-carousel-card-footer">
                                <div class="knsl-carousel-price">
                                    <span class="knsl-price-val">&euro;99</span>
                                    <span class="knsl-price-lbl"><?php esc_html_e('per night', 'resort-hotel'); ?></span>
                                </div>
                                <a href="<?php echo esc_url(home_url('/accommodation/superior-ocean-room/')); ?>" class="knsl-carousel-book-btn">
                                    <svg class="knsl-book-icon" viewBox="0 0 18 23" aria-hidden="true">
                                        <path d="M0,0 L0,23 L1.594,21.813 L9,16.25 L16.406,21.813 L18,23 L18,0 L0,0 Z M2,2 L16,2 L16,19 L9.594,14.188 L9,13.75 L8.406,14.188 L2,19 L2,2 Z"/>
                                    </svg>
                                    <span><?php esc_html_e('BOOK', 'resort-hotel'); ?></span>
