        ...
        <div class="site-navigation">
            ...
            ?>
                <ul class="nav-menu">
                    ...
                    <li class="nav-item <?php echo (is_page('about') || is_page('services') || is_page_template('page-services.php')) ? 'active' : ''; ?>">
                        <a href="<?php echo esc_url(home_url('/#about')); ?>" class="nav-link <?php echo (is_page('about') || is_page('services') || is_page_template('page-services.php')) ? 'is-active' : ''; ?>">
                            <span>About</span>
                            <svg class="chevron-icon" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6"/></svg>
                        </a>
                        <ul class="sub-menu">
